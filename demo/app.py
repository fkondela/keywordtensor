...
# Monkey-patch naprawiający błąd boolean schema w starszych wersjach (zabezpieczony przed zmianami w Gradio 5)
try:
    ...
    # W nowym Gradio funkcja mogła zostać przeniesiona lub usunięta - zakładamy, że błąd bool jest już naprawiony
    pass
